  ...
  return (
    <div className="flex flex-col min-h-screen items-center justify-center font-sans ">
      ...
      <main className=" w-full mt-16 mb-8 space-y-8">
        <Divider />
        <h2 className='text-3xl text-center'>&lt;-- O wydarzeniu --&gt;</h2>
        <section className="p-8 flex  gap-8 flex-col justify-between items-between w-full min-h-[600px] w-full lg:w-3/5 mx-auto" >
          <div className='max-w-xl self-start text-lg'>
          ...
          <div className='max-w-xl self-end text-lg'>
        ...
        <Divider />
        <h2 className='text-3xl text-center'>&lt;-- Lokalizacja wydarzenia --&gt;</h2>
        ...
        <Divider />
        <h2 className='text-3xl text-center'>&lt;-- Organizatorzy --&gt;</h2>
