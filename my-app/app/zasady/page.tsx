...
export default function Regulamin() {
  ...
  const handleDownloadPolityka = () => {
    const link = document.createElement("a");
    link.href = "/polityka.pdf";
    link.download = "Polityka_Prywatnosci_Idea2Impact.pdf";
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
  };
  ...
  return (
    <main className="min-h-screen  pt-20 text-justify  ">
      ...
      <section className=" w-9/10 mx-auto  max-w-5xl lg:px-4 pb-6">
        ...
        <ol className="list-decimal list-outside px-2 ml-4 lg:ml-8 lg:px-8 space-y-4 mb-6">
          ...
          <li>
            ...
            24 godziny – od godziny 18:00 w dniu 7 marca 2026 r. do godziny
            18:00 w dniu 8 marca 2026 r.
          </li>
          <li>
      ...
      <section className=" w-9/10 mx-auto px-2 max-w-5xl lg:px-12 pb-6">
        ...
        <h4 className="font-bold mt-8">1. Informacje ogólne</h4>
        <p>
          Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem
          url: https://www.infiro.pl. Operatorem serwisu oraz Administratorem
          danych osobowych jest:
          <span className="font-semibold"> Fundacja Infiro</span> z siedzibą w
          Gdyni przy ul. Śląskiej 53/A403A, 81-304 Gdynia wpisana do rejestru
          ...
          Gdańsku VIII Wydział Gospodarczy Krajowego Rejestru Sądowego pod nr
          KRS 0001134863, NIP: 5862411258, REGON: 54001474500000. Adres
          kontaktowy poczty elektronicznej operatora: kontakt@infiro.pl Operator
        ...
        <ul className="list-disc ml-8 mt-2 space-y-2">
          <li>Obsługa zapytań przez formularze kontaktowe</li>
        ...
        <p>
          Istotnym elementem ochrony danych jestregularna aktualizacja
        ...
        <h4 className="font-bold mt-8">3.Hosting</h4>
        <p>
        ...
        <p>
          ...
          Administratorze. Dotyczy to takich grup odbiorców: upoważnieni
        ...
        <p className="mt-4">Przysługuje Ci prawo żądania od Administratora:</p>
        <ul className="list-disc ml-8 mt-2 space-y-2">
        ...
        <p>
          Podanie danych osobowych jest dobrowolne i nie jest niezbędne do
          obsługi Serwisu.
        </p>
        <p>
        ...
        <h4 className="font-bold mt-8">5. Informacje o formularzach</h4>
        <p>
        ...
        <h4 className="font-bold mt-8">6. Logi Administartora</h4>
        <p>
        ...
        <h4 className="font-bold mt-8">7. Istotne techniki marketingowe</h4>
        <p>
        ...
        <h4 className="font-bold mt-8">8. Informacja o plikach cookies</h4>
        <p>Serwis korzysta z plików cookies.</p>
        <p>
          liki cookies (tzw. „ciasteczka”) stanowią dane informatyczne, w
        ...
        <p>
          ...
          hasła; realizacji celów określonych powyżej w części „Istotne techniki
          marketingowe”
        </p>
        <p>
        ...
        <p>
          ...
          przypadkach może uniemożliwić korzystanie ze strony www.
        </p>
      </section>
      <div className="w-full flex justify-center lg:pb-8">
        <button
          onClick={() => {
            handleDownloadPolityka();
          }}
          className="mt-8 px-6 py-3 bg-white text-primary font-semibold font-inter rounded-lg text-2xl w-fit mx-auto shadow-md transition-transform duration-200 ease-out hover:scale-105 hover:-translate-y-0.5 hover:shadow-lg hover:bg-gray-100"
        >
